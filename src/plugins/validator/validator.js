          ...
          if(option.vanow){
              el.addEventListener('change', function(){
                    ...
                    if(_result){
                        ...
                        typeof _result === 'string' ? vm.$toast(_result,false) : showErr(conditions[0].tag, _result, vm)
            ...
            el.addEventListener('click', function(){
                ...
                for(var i = 0;i < domList.length;i++){
                    ...
                    if(_result){
                        ...
                        typeof _result === 'string' ? vm.$toast(_result,false) : showErr(conditions[0].tag, _result,vm)
                        dom.focus()
                        dom.parentNode.style.border = "1px solid #ff8080"
                        dom.value = ''
                        return
                    } else {
