<template>
  <div class="c2c">
    ...
    >
      ...
      <SaleOrderList v-show="selected === 0" :C2Ctype="'1'" :list="goodsList" @toDetail="toDetail" @onSale="buy">
      </SaleOrderList>
      <!--</transition>-->
      <OrderList v-show="selected === 1" :C2Ctype="'1'" :list="goodsList" @toDetail="toDetail" @onBuy="sale">
      </OrderList>

      <MyOrder v-show="selected === 2" :C2Ctype="'1'" :list="goodsList" @toOrderDetail="toOrderDetail">
      </MyOrder>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      publish(String) {
        this.$router.push({path: '/PublishC2C', query: {'type': String}})
      },
      refresh(done) {
        setTimeout(() => {
          done()
